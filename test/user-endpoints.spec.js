    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: 'はい', translation: 'no' },
            { original: 'ありがとう', translation: 'thank you' },
            { original: 'どういたしまして', translation: "you're welcome" },
            { original: 'すみません', translation: 'excuse me' },
            { original: 'おはようございます', translation: 'good morning' },
            { original: 'こんにちは', translation: 'hello' },
            { original: 'おやすみなさい', translation: 'good night' },
            { original: 'はい', translation: 'yes' }
          ]
        };
